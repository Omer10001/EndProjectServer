...
namespace EndProjectServer
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            string connectionString = this.Configuration.GetConnectionString("EndProjectDB");

            services.AddDbContext<EndProjectDBContext>(options => options
